...
public class Sales {
    public static void main(String[] args) {
        ...
        // Open employee page
        driver.manage().window().maximize();
        driver.get("http://127.0.0.1:5500/frontend/employee.html");

        // click Add employee and close it
        WebElement updateInventoryBTN =
                wait.until(ExpectedConditions.elementToBeClickable(By.className("px-4")));
